...
class TestAPIEndpointsExist:
    ...
    async def test_users_endpoint_exists(self):
        ...
        async with AsyncClient(
            ...
            response = await client.post(
                "/api/users",
                json={"email": _uniq_email("test"), "name": "Test"}
            )
    ...
    async def test_orders_endpoint_exists(self):
        ...
        async with AsyncClient(
            ...
            user_response = await client.post(
                "/api/users",
                json={"email": _uniq_email("ordertest"), "name": "Order Test"}
            )
    ...
    async def test_pay_endpoint_exists(self):
        ...
        async with AsyncClient(
            ...
            user_response = await client.post(
                "/api/users",
                json={"email": _uniq_email("paytest"), "name": "Pay Test"}
            )
            user_id = user_response.json()["id"]
    ...
    async def test_cancel_endpoint_exists(self):
        ...
        async with AsyncClient(
            ...
            user_response = await client.post(
                "/api/users",
                json={"email": _uniq_email("canceltest"), "name": "Cancel Test"}
            )
            user_id = user_response.json()["id"]
